...
if __name__ == "__main__":
    ...
    #---------------------------------------------------------------------#
    classes_path    = '/home/zhoukang/GithubProject/detr-deploy/python/model_data/voc_classes.txt'
    #----------------------------------------------------------------------------------------------------------------------------#
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = "/home/zhoukang/GithubProject/detr_from_bubbliiiing/model_data/detr_resnet50_weights_coco.pth"
    #------------------------------------------------------#
